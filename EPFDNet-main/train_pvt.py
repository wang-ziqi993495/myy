...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='D:/研究生/四大/COD10K_CAMO_CombinedTrainingDataset/',
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default='D:/研究生/四大/Dataset/TestDataset/CAMO/',
    ...
    model = Network().to(device)  # 使用 .to(device) 替代 .cuda()
